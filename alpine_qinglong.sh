...
&& mkdir -p $QL_DIR \
&& git clone -b $QL_BRANCH https://ghproxy.net/github.com/whyour/qinglong.git $QL_DIR \
&& cd $QL_DIR \
...
&& git clone -b $QL_BRANCH https://ghproxy.net/github.com/whyour/qinglong-static.git $QL_DIR/static \
